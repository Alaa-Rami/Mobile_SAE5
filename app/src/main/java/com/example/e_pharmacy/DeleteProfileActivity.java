...
public class DeleteProfileActivity extends AppCompatActivity {
    ...
    private TextView textViewViewAuthenticated;
    private ProgressBar progressBar;
    private String userPwd;
    private Button buttonReAuthenticate, buttonDleteUser;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Dlete your Profile");
        progressBar=findViewById(R.id.progressBar);
        editTextUserPwd=findViewById(R.id.editText_delete_user_pwd);
        textViewViewAuthenticated = findViewById(R.id.textView_delete_user_authenticated);
        buttonDleteUser=findViewById(R.id.button_delete_user);
        buttonReAuthenticate=findViewById(R.id.button_delete_user_authenticate);

        buttonDleteUser.setEnabled(false);
            ...
            buttonReAuthenticate.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (TextUtils.isEmpty(userPwd)){
                        Toast.makeText(DeleteProfileActivity.this,"password is required!",Toast.LENGTH_LONG).show();
                        ...
                        firebaseUser.reauthenticate(credential).addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                if (task.isSuccessful()){
                                    ...
                                    buttonDleteUser.setEnabled(true);

                                    textViewViewAuthenticated.setText("you are authenticated , you can delete your profile now !");
                                    Toast.makeText(DeleteProfileActivity.this,"password has been verified , delete your profile now",Toast.LENGTH_LONG).show();

                                    buttonDleteUser.setBackgroundTintList(ContextCompat.getColorStateList(DeleteProfileActivity.this , R.color.dark_green));

                                    buttonDleteUser.setOnClickListener(new View.OnClickListener() {
                                        @Override
                                        public void onClick(View view) {
                                            showAlerteDialog();
                                        }
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (id==R.id.menu_refresh){
            ...
            Toast.makeText(DeleteProfileActivity.this,"",Toast.LENGTH_LONG).show();
